...
OUTPUT_MODEL_PATH="/speech/arjun/shoutrik/Qwen3-TTS/finetuning/v5/experiments/entity_injection_v5.2"

# Data
TRAIN_JSONL="/speech/arjun/shoutrik/DATA/google_tn_metadata.jsonl"
...
ACCELERATE_CONFIG="/speech/arjun/shoutrik/Qwen3-TTS/finetuning/v5/default_config.yaml"
...
$ACCELERATE_CMD "sft_12hz_with_EntityInjection_v5.py" \
